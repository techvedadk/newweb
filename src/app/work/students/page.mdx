...
export const caseStudy = {
  client: 'Students of Strength Foundation',
  title: 'Online tutoring and test prep platform',
  description:
    'Students of Strength Foundation is a non-profit that provides tutoring and test prep to students from low-income families. We helped them build a platform to connect students with tutors and mentors',
  summary: [
    'Students of Strength Foundation is a non-profit that provides tutoring and test prep to students from low-income families. We helped them build a platform to connect students with tutors and mentors.',
    'We developed a custom CMS to power their platform and deliverd Hybrid mobile apps',
  ],
  logo,
  image: { src: imageHero },
  date: '2023-01',
  service: 'Web development, Mobile Development, CMS',
  testimonial: {
    author: { name: 'Rahsaan King', role: 'CEO of Students of Strength Foundation' },
    content:
      'Working with Techveda, we felt more like a partner than a customer. They really resonated with our mission.',
  },
}
