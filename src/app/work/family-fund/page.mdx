import logo from '@/images/clients/google/logo-light.svg'
...
export const caseStudy = {
  ...
  testimonial: {
    ...
    content:
      'Working with Techveda, we felt more like a partner than a customer. They really resonated with our mission to change the way people convince their parents to cash out their pensions.',
  },
}
